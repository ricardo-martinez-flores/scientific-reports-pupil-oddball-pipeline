...
the method is covered by a pending patent application and will be made
available separately once that process is complete (see the Data/Code
...
def run_pupil_analysis(data_path, output_dir="."):
    ...
    print("  Vergence is NOT processed in this script (patent-pending; see manuscript).")
